...
<title>COAT | Student Details</title>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card">
							<div class="card-body">
								<a href="liststudent?studentId=${student.studentId}">Back</a><br><br>
									<b>First Name</b> : ${student.firstName}<br>
									<b>Last Name</b> : ${student.lastName}<br>
									<b>Email</b> : ${student.email}<br>
									<b>Password</b> : ${student.password}<br>
									<b>ContactNo</b> : ${student.contactNo}<br>
									<b>RoleId</b> : <c:if test="${student.roleId == 2}"> Student </c:if><br> 
								</div>
							</div>
						</div>
					</div>
