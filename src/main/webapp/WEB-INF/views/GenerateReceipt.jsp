        ...
        <div class="receipt-main col-xs-6 col-sm-6 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3" id="invoice">
    			...
    			<div class="receipt-header">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 text-right">
						<div class="receipt-right">
							<h4 class="text-center font-weight-bold fs-3">Admission Form Fee Receipt</h4>
							<p><hr class="l-3 w-50 h-50"></p>
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="reciept-right">
							<h6 class="font-weight-bold w-25 ml-4">AdmissionId: ${admission.admissionId}</h6>
            ...
            <div>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9">Admission Form Fee</td>
                            <td class="col-md-3"><i class="fa fa-inr"></i> ${admission.payment}/-</td>
                        </tr>
                        <tr>
                            <td class="text-right">
                            <p>
                            ...
                            <td>
                            <p>
                                <strong><i class="fa fa-inr"></i> ${admission.payment}/-</strong>
                            </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left text-danger "><h2 class="justify-content-center text-center "><strong><i class="fa fa-inr"></i> ${admission.payment}/-</strong></h2></td>
                        </tr>
                    </tbody>
                </table>
            </div>
