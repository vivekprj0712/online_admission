...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
 ...
 <div class="row justify-content-center text-center">
        ...
        <div class="receipt-main col-xs-6 col-sm-6 col-md-6	 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
    			<div class="receipt-header">
					<div class="col-xs-12 col-sm-12 col-md-12 receipt-center">
						
						<h3 class="text-danger  text-center">${msg}</h3><br>
						</div>
					
				</div>
            </div>
			
    		<a href="studentdashboard" class="btn btn-outline-danger">Back</a>
