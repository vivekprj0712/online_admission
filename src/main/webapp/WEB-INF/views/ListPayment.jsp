		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">List of Payment</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
										...
										<tbody>
											<c:forEach items="${payments}" var="p">
												<tr>
													...
													<td>${p.courseId}</td>
													<td>
													<a href="viewpayment?paymentId=${p.paymentId}"><i class="ion ion-ios-eye fa-2x ml-2 text-primary"></i></a>
