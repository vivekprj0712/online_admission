...
<title> COAT | List Feedback</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">List of Feedbacks</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body table-responsive p-0">
										...
										<tbody>
											<c:forEach items="${feedbackList}" var="ft">
													<tr>
														<td>${ft.feedbackId}</td>
														<td>${ft.firstName}</td>
														<td>${ft.lastName}</td>
														...
														<td>${ft.subject}</td>
														<td>${ft.message}</td>
														<td><a href="deletefeedback?feedbackId=${ft.feedbackId}"><i class="ion ion-ios-trash fa-2x text-danger"></i></a></td>
													</tr>
											</c:forEach>
