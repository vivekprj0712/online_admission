  ...
  <div class="site-wrap">
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="/" class="d-block">
              ...
              <img src="dist/images/hngu-logo.png" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="listteacher">Our Teachers</a></li>
                ...
                <li>
                  ...
                  <li>
                    <a href="feedback" class="nav-link text-left">FeedBack</a>
                  </li>
              </ul>                                                                                                                                                                                                                                                                                          </ul>
            </nav>
    ...
    <div class="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="dist/images/logo.png" alt="Image" class="img-fluid"></p>
