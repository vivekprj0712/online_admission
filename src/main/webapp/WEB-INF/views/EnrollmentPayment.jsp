...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
        ...
        <form action="savepayment?${admission.admissionId}"  method = "post">
            <div class="row">
                <div class="col-md-6 form-group">
                    <label class="text-black">Tuition Fees</label>
 					
 					<div class="col-md-6 form-group dropdown has-children row">
                        Select  Cost
                        <select class="dropdown-toggle" name="paymentCost" required="required">	
                        	 <option value="17500">17,500 (6 Months)</option>
       						 <option value="35000" selected="selected">35,000 (12 Months)</option>
       				    </select>						
                        </div>			
                     </div>
                    </div>
                    		<input type="hidden" id="date" name = "date" class="form-control form-control-lg" value="${date}">
                        	...
                        	<input type="hidden" id="status" name = "merit" class="form-control form-control-lg" value="${merit.roundTitle}">
